...
/* package tekitou-0.1.0.0 */
#define VERSION_tekitou "0.1.0.0"
#define MIN_VERSION_tekitou(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "tekitou-0.1.0.0-8KQ2ql5YKn755AFwEzqOna"

#define CURRENT_PACKAGE_KEY "tekitou-0.1.0.0-8KQ2ql5YKn755AFwEzqOna"
